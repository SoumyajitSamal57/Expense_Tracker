          ...
          <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-cyan-600 flex items-center justify-center shadow-md">
              ...
              <button
                onClick={toggleTheme}
                className="w-8 h-8 rounded-lg flex items-center justify-center transition-all bg-gray-100 dark:bg-gray-800 hover:bg-cyan-100 dark:hover:bg-cyan-900/40 text-gray-500 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400"
                  ...
                  <>
                    <div
                      className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${
                        isActive ? "bg-cyan-100 dark:bg-cyan-900/50" : "bg-transparent"
                      }`}
                    >
                      <Icon
                        className={`w-4 h-4 ${
          ...
          <div className="px-4 py-4 border-t border-gray-100 dark:border-gray-800">
            {editingName ? (
              <div className="flex items-center gap-2 px-2">
                <div className="w-8 h-8 rounded-full bg-rose-500 flex items-center justify-center text-white shrink-0" style={{ fontSize: "0.7rem", fontWeight: 700 }}>
                  {userInitials}
                </div>
                <input
                  ref={inputRef}
                  ...
                  maxLength={30}
                  className="flex-1 min-w-0 bg-gray-50 dark:bg-gray-800 border border-cyan-300 dark:border-cyan-600 rounded-lg px-2 py-1 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-cyan-300"
                  style={{ fontSize: "0.8rem" }}
                />
                <button
                  onClick={handleSaveName}
                  className="w-6 h-6 bg-cyan-100 dark:bg-cyan-900/50 rounded-md flex items-center justify-center hover:bg-cyan-200 dark:hover:bg-cyan-800 transition shrink-0"
                >
              ...
              <div className="flex items-center gap-3 px-2 group">
                ...
                <button
                  ...
                  className="w-6 h-6 rounded-md flex items-center justify-center opacity-0 group-hover:opacity-100 bg-gray-100 dark:bg-gray-800 hover:bg-cyan-100 dark:hover:bg-cyan-900/40 transition shrink-0"
                  title="Edit name"
                >
                  <Pencil className="w-3 h-3 text-gray-400 hover:text-cyan-500" />
                </button>
              </div>
            )}
          </div>
